...
public class Graph<T> implements GraphADT<T> {
  ...
  public void removeEdge(int index1, int index2) {
	...
	public Iterator iteratorShortestPath(T startVertex, T targetVertex) {
        ...
        //verifica se os indexes são validos, caso contrario retorna um iterator vazio
        ...
        while (!traversalQueue.isEmpty()) {
            x = traversalQueue.dequeue();
            /**
             * Encontra todos os vertices adjacentes a x e incrementa 1 à
             * distancia dos que ainda não foram visitados
             */
            for (int i = 0; i < numVertices; i++) {
                if (adjMatrix[x.intValue()][i] && !visited[i]) {
                    traversalQueue.enqueue(new Integer(i));
            ...
            //pára o cilco quando o endIndex for visitado
